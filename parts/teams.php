        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 ml-auto mr-auto">
                    <h4 class="title text-center">Equipos</h4>
                    <div class="nav-align-center">
                        <ul class="nav nav-pills nav-pills-primary nav-pills-just-icons" role="tablist">
                            <li class="nav-item caluga">
                                <a class="nav-link active" data-toggle="tab" href="#muro" role="tablist">
                                    <!-- <i class="now-ui-icons design_image"></i> -->
                                    <!-- <img src="assets/img/equipos/logos/anwo.png"> -->Split Muro
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#piso-cielo" role="tablist">
                                    <!-- <i class="now-ui-icons location_world"></i> -->Split Piso/Cielo On/Off
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#splitducto" role="tablist">
                                    <!-- <i class="now-ui-icons sport_user-run"></i> -->Split Ducto
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#splitcasette" role="tablist">
                                    <!-- <i class="now-ui-icons sport_user-run"></i> -->Split Cassette
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#portatil" role="tablist">
                                    <!-- <i class="now-ui-icons sport_user-run"></i> -->Aire Acond. Portátil
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#termost" role="tablist">
                                    <!-- <i class="now-ui-icons sport_user-run"></i> -->Termost Fan Coil
                                </a>
                            </li>
                            <li class="nav-item caluga">
                                <a class="nav-link" data-toggle="tab" href="#ventana" role="tablist">
                                    <!-- <i class="now-ui-icons sport_user-run"></i> -->Ventana
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="tab-content gallery">
                    <div class="tab-pane active" id="muro" role="tabpanel">
                    ...
                    <div class="tab-pane" id="piso-cielo" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
                    ...
                    <div class="tab-pane" id="splitducto" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
                    ...
                    <div class="tab-pane" id="splitcasette" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
                    ...
                    <div class="tab-pane" id="portatil" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
                    ...
                    <div class="tab-pane" id="termost" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
                    ...
                    <div class="tab-pane" id="ventana" role="tabpanel">
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="row collections">
                                <div class="col-md-6 prodimg">
